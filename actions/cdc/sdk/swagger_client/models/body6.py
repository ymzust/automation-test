...
class Body6(object):
    ...
    @property
    def ids(self):
        """Gets the ids of this Body6.  # noqa: E501

        Alert ids to add  # noqa: E501

        :return: The ids of this Body6.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this Body6.

        Alert ids to add  # noqa: E501

        :param ids: The ids of this Body6.  # noqa: E501
        :type: list[str]
        """
        if ids is None:
